...
if(!empty($_POST["classid1"])) 
{
 ...
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {?>
  <p> <?php echo htmlentities($row['SubjectName']); ?><input type="text"  name="cat1s[]" value="" class="form-control" required="" placeholder="Enter CAT 1 out of 15" autocomplete="off"></p>
  <p> <?php echo htmlentities($row['SubjectName']); ?><input type="text"  name="cat2s[]" value="" class="form-control" required="" placeholder="Enter CAT 2 out of 15" autocomplete="off"></p>
  <p> <?php echo htmlentities($row['SubjectName']); ?><input type="text"  name="exams[]" value="" class="form-control" required="" placeholder="Enter Exam out of 70" autocomplete="off"></p>
